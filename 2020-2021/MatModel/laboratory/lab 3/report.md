...
subtitle: "Модель боевых действий - вариант 43"
...
![Жесткая модель войны](image/03.png){ #fig:001 width=70% height=70% }
...
![Фазовые траектории для второго случая](image/04.png){ #fig:002 width=70% height=70% }
...
В начальный момент времени страна $X$ имеет армию численностью 227000 человек, а в распоряжении страны $Y$ армия численностью в 139000 человек.
...
$$
 \begin{cases}
	\frac{dx}{dt}= -0.34x(t) - 0.87y(t) + sin(t) + 2
	\\   
	\frac{dy}{dt}= -0.51x(t) - 0.2y(t) + 2|cos(t)|
 \end{cases}
$$


![График численности для случая 1](image/05.png){ #fig:003 width=70% height=70% }
...
$$
 \begin{cases}
	\frac{dx}{dt}= -0.24x(t) - 0.75y(t) + sin(8t) + 1
	\\   
	\frac{dy}{dt}= -0.28x(t)y(t) - 0.18y(t) + 2|cos(t)|
 \end{cases}
$$


![График численности для случая 2](image/06.png){ #fig:004 width=70% height=70% }
